...
export default function OfficeHours() {
  ...
  return (
    <>
      <Head>
        <title>Schedule Office Hours with Bermon</title>
        <meta name="description" content="Office hours are held every Friday morning from 7am-9am EST." />
      </Head>
      <div className="container mx-auto px-4">
        <h1 className="text-2xl font-semibold">Schedule Office Hours with Bermon</h1>
        <p className="mb-4">Office hours are held every Friday morning from 7am-9am EST.</p>
        <div 
          className="calendly-inline-widget" 
          data-url="https://calendly.com/bermon-painter/office-hours?hide_event_type_details=1&hide_gdpr_banner=1" 
...
//       headers: {
//         'Authorization': `Bearer ${process.env.NEXT_PUBLIC_CALENDLY_SECRET}`
//       }
//     }).then(response => {
